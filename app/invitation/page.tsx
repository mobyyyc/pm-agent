...
export default function InvitationPage() {
  ...
  if (status === "loading") {
    return <div className="mx-auto max-w-5xl px-4 py-6 text-neutral-300 sm:py-8 md:px-6">Loading invitation...</div>;
  }
        ...
        {loadingInvitations ? (
          ...
          <ul className="space-y-3">
            {invitations.map((invitation) => (
              <li
                key={invitation.id}
                className="timeline-frame-item app-frame-item app-frame-hover rounded-xl bg-white/5 p-4 transition-all duration-300 ease-in-out hover:bg-white/10"
              >
