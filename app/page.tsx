      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="inline-flex h-11 items-center justify-center gap-2 rounded-full border border-white/20 bg-transparent px-6 text-sm font-semibold leading-none text-white transition-colors hover:border-white/40"
          >
