  ...
  if (session) {
    return (
      <div className="flex items-center gap-4">
        ...
        <button
          onClick={() => signOut()}
          className="rounded-md bg-red-600 px-3 py-1.5 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-red-600"
        >
          Sign out
        </button>
      </div>
